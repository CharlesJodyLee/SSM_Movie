...
<body>
    ...
    <div >
        <table align="center" >
            ...
            <tr id="tr1">
                <td><a id="a1" href="addStudent.jsp" class="layui-btn">注册学生</a></td>
            </tr>
            <tr id="tr2">
                <td><a id="a2" href="listStudent.jsp" class="layui-btn">浏览学生</a></td>
            </tr>
            <tr id="tr3">
                <td><a id="a3" href="addMovie.jsp" class="layui-btn">添加电影</a></td>
            </trid>
            <tr>
    ...
    <div align="center">
        <form id="hideFormPower" action="student/powerCheck.do">
